...
import sys
# sys.path.append("C:/Users/tucng/OneDrive/Máy tính/GCN-RS/")
from GCN.config import config
from GCN.data_preparation import data_utils
from GCN.training.NCF import model_graph
...
class Utils:
    ...
    def load_data(self):
        ...
        num_user, num_item = data_utils.load_representation_data_from_training(
            self.root_path + "ITE/ratings_train.txt")
        self.hyper_params["num_user"] = num_user
        self.hyper_params["num_item"] = num_item
        interact_mat = data_utils.load_interact_matrix_NeuMF(self.root_path + "ITE/ratings_train40.txt",
                                                             num_user,
                                                             num_item,
                                                             self.hyper_params["use_implicit"])
        # training_dict = data_utils.load_train_data(self.train_path + "scene_1/train.txt")
        test_data = data_utils.load_test_data(self.root_path + "ITE/ratings_test.txt")
        negative_data = data_utils.load_negative_data_for_retail(self.root_path + "ITE/negative_test.txt")
    ...
    def build_graph(self):
        ...
        """
        return model_graph.NeuMF.create_model(self.hyper_params)
    ...
    def train(self, model, data):
        ...
        with tf.Session(config=session_conf) as sess:
            ...
            for e in range(1, num_epoch + 1):
                ...
                train_path = self.root_path + "ITE/ratings_train40.txt"
                ...
                user_indices, item_indices, labels = data_utils.get_train_instances_partition_NeuMF(
                    train_path, interact_mat, num_neg, num_item, use_implicit)
