...
data_name = "ml-1m/"
root_path = config.DATA_ROOT_PATH + 'site_data/' + data_name
...
def build_user_pcat_repr():
    ...
    user_repr_rdd = ex_df.rdd \
        ...
        sparse_vector.dense_vector_to_list_sparse_vector(x, threshold=0.01)))
...
def main():
    ...
    # data_preparation.div_train_test_data_without_implicit_in_train(combined_data, output_root_name)
