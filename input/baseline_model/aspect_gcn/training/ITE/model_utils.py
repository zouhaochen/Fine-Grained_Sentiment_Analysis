...
from GCN.training.ITE import model_graph
...
class Utils:
    ...
    def load_data(self):
        ...
        interact_mat = data_utils.load_interact_matrix(
            self.root_path + self.hyper_params["data_scene"] + "ITE/ratings_train.txt", num_user,
            num_item)
        test_data = data_utils.load_test_data(self.root_path + self.hyper_params["data_scene"] + "ITE/ratings_test.txt")
        negative_data = data_utils.load_negative_data(
            self.root_path + self.hyper_params["data_scene"] + "ITE/negative_test.txt")
    ...
    def set_hyper_params(self, hyper_params, save_eval_result, save_model):
        ...
        self.eval_result_path = self.root_path + "eval_results/{}/{}/{}/{}_{}_{}_{}_{}".format(
    ...
    def train(self, model, data):
        ...
        with tf.Session() as sess:
            ...
            for e in range(1, num_epoch + 1):
                ...
                r_test_loss = 0.0
                num_batch = 0
                train_path = self.root_path + self.hyper_params["data_scene"] + "ITE/ratings_train.txt"
